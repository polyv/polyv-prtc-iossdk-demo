...
@interface PLVResolutionPickerView : UIView
...
@implementation PLVResolutionPickerView
...
@interface PRTCResolutionChoosePicker() <UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation PRTCResolutionChoosePicker

/**
 PCloudRtcEngine_VideoProfile_180P_1 = 0, // 分辨率:240*180,  码率范围:100-200kpbs, 帧率:15fps
 PCloudRtcEngine_VideoProfile_180P_2 = 1, // 分辨率:320*180,  码率范围:100-200kpbs, 帧率:15fps
 PCloudRtcEngine_VideoProfile_360P_1 = 2, // 分辨率:480*360,  码率范围:100-300kpbs, 帧率:15fps(默认值)
 PCloudRtcEngine_VideoProfile_360P_2 = 3, // 分辨率:640*360,  码率范围:100-400kpbs, 帧率:20fps
 PCloudRtcEngine_VideoProfile_480P = 4,   // 分辨率:640*480,  码率范围:100-500kpbs, 帧率:20fps
 PCloudRtcEngine_VideoProfile_720P = 5,   // 分辨率:1280*720, 码率范围:300-1000kpbs,帧率:30fps
 PCloudRtcEngine_VideoProfile_1080P = 6,  // 分辨率:1920*1080,码率范围:500-1500kpbs,帧率:30fps
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    PLVResolutionPickerView *pView =(PLVResolutionPickerView *)view;
    if (!pView) {
        pView = [[PLVResolutionPickerView alloc] initWithFrame:CGRectMake(0, 0, pickerView.frame.size.width, 50)];
    }
