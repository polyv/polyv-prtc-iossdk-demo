...
@interface PLVSettingsViewController ()<PLVSliderDelegate>
...
@property (weak, nonatomic) IBOutlet PLVSlider *mSlider;

@end

@implementation PLVSettingsViewController{
    NSInteger isVideo;
    NSInteger isAudio;
    NSInteger isAutoPub;
    NSInteger isAutoSub;
...
- (void)setupUI {
    ...
    self.mSlider.sliderStyle = PLVSliderStyle_Point;
